        ...
        node (pipelineParams.BUILD_NODE)
        {
          ...
          stage("War Deployment")
          {
            new app_deployment().call(pipelineParams)
		      ...
		      {
            sh '''
              curl -v -u admin:admin --upload-file $WORKSPACE/$REPO/target/dummy_webapp-0.0.1-SNAPSHOT.war http://192.168.1.19:8081/#browse/browse:nexus_optimizer_repo/com.amita/1.0/dummy_webapp-0.0.1-SNAPSHOT.war
            '''
		      }
	}
        }
